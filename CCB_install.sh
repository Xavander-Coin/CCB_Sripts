...
-echo "*                                                                          *"
-echo "* This script will install and configure your CCB Coin Masternode.         *"
-echo "****************************************************************************"
-echo && echo && echo
-echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
-echo "!                                                 !"
...
COIN_TGZ='ttps://github.com/CryptoCashBack/CryptoCashBack/releases/CryptoCashBack-Linux.tar.gz'
